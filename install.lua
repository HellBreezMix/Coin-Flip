...
--   lua install.lua
--
-- Скрипт создаст папку /CoinFlip и скачает в неё main.lua и config.lua.
...
local REPO_RAW = "https://raw.githubusercontent.com/HellBreezMix/Coin-Flip/main/"

local INSTALL_DIR = "/CoinFlip/"
...
ensureDir(INSTALL_DIR .. "x") -- гарантированно создаст /CoinFlip/
...
if hadError then
    ...
    print("Запуск:  lua /CoinFlip/main.lua")
